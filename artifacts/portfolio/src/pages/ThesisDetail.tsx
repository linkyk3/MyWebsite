  ...
  return (
    <>
      ...
      <div
        ...
        style={{ backgroundImage: `url(${BASE}thesis/hero-background.png)`, minHeight: '50vh' }}
      >
      ...
      <article className="prose prose-invert max-w-none px-8 md:px-16 lg:px-24 py-12 text-foreground/90 prose-p:leading-relaxed prose-p:text-justify">
        ...
        <Image src={`${BASE}thesis/extract-2.png`} alt="Extract 2" />
        ...
        <ImageGrid>
          <Image src={`${BASE}thesis/extract-1.png`} alt="Extract 1" />
          <Image src={`${BASE}thesis/extract-3.png`} alt="Extract 3" />
        </ImageGrid>
        ...
        <Image src={`${BASE}thesis/extract-4.png`} alt="Extract 4" />
        ...
        <ImageGrid>
          <Image src={`${BASE}thesis/extract-5.png`} alt="Extract 5" />
          <Image src={`${BASE}thesis/extract-6.png`} alt="Extract 6" />
        </ImageGrid>
        ...
        <Image src={`${BASE}thesis/extract-7.png`} alt="Extract 7" />

        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 my-8">
          <Image src={`${BASE}thesis/extract-9.png`} alt="Extract 9" />
          <Image src={`${BASE}thesis/extract-10.png`} alt="Extract 10" />
          <Image src={`${BASE}thesis/extract-11.png`} alt="Extract 11" />
          <Image src={`${BASE}thesis/extract-12.png`} alt="Extract 12" />
        </div>
        ...
        <Image src={`${BASE}thesis/extract-8.png`} alt="Extract 8" />
        ...
        <Image src={`${BASE}thesis/extract-13.png`} alt="Extract 13" />
        ...
        <Image src={`${BASE}thesis/extract-14.png`} alt="Extract 14" />
        ...
        <ImageGrid>
          <Image src={`${BASE}thesis/extract-15.png`} alt="Extract 15" />
          <Image src={`${BASE}thesis/extract-16.png`} alt="Extract 16" />
        </ImageGrid>
        ...
        <Image src={`${BASE}thesis/extract-17.png`} alt="Extract 17" />
        ...
        <Image src={`${BASE}thesis/extract-18.png`} alt="Extract 18" />
        ...
        <Image src={`${BASE}thesis/extract-19.png`} alt="Extract 19" />
        ...
        <Image src={`${BASE}thesis/extract-20.png`} alt="Extract 20" />
      </article>
      </div>
    </>
  );
